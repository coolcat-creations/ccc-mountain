...
$this->addStyleSheet($tplpath . '/css/template.min.css');
...
$this->addScript('https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js', '', array('integrity'=>'', 'crossorigin' => 'anonymous', 'defer'=>'defer', 'async'=>'async' ));
$this->addScript($tplpath . '/js/bootstrap.min.js', '', array('defer'=>'defer', 'async'=>'async' ));
$this->addScript($tplpath . '/js/custom.js', '', array('defer'=>'defer', 'async'=>'async' ));
